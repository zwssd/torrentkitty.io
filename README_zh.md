...
* 安装Python的依赖模块：Scrapy, sqlite3, requests 或 `pip install -r requirements.txt`
...
## 数据库说明
已经将数据库修改为sqlite3,数据库文件是:lang151.db
数据库中保存数据的表是 lang151。以下是字段说明:

#### lang151 表：
	
	title:视频的标题,并作为唯一标识.
	url:视频的m3u8地址（base64解密后）
